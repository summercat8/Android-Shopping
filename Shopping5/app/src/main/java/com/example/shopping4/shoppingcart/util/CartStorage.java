package com.example.shopping4.shoppingcart.util;

import android.content.Context;
import android.text.TextUtils;
import android.util.SparseArray;

import com.example.shopping4.app.MyApplication;
import com.example.shopping4.home.bean.Goodsbean;
import com.example.shopping4.utils.CacheUtils;
...
public class CartStorage {
    ...
    public List<Goodsbean> getAllData() {
        ...
        if(!TextUtils.isEmpty(json)){
            //把String转换成List<Goodsbean>类型的对象
